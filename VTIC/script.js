 ...
 * ownInitials 순서 그대로 행 이니셜 + 열 이니셜로 조합했어요.
 */
const pairNames = [
    ["엋엋", "엋율", "엋신", "엋단", "엋뱐"],
    ["율엋", "율율", "율신", "율단", "율뱐"],
...
const CUSTOM_COLOR_KEY = "vtic-custom-colors";
...
const STORAGE_KEY = "vtic-rps";
const LR_STORAGE_KEY = "vtic-lr-rps";
const LR_CELL_COUNT = 12;

/* 행/열 개별 숨기기 상태 (멤버 인덱스 기준, rows/cols 따로 관리) */
const HIDDEN_KEY = "vtic-hidden-members";
...
const SELF_PAIR_KEY = "vtic-include-selfpair";
...
saveBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        const fileLabel = currentTab === "rps" ? "브이틱페스_취향표" : "공수_취향표";

        const link = document.createElement("a");
        link.href = currentBlobUrl;
        link.download = `브이틱_${fileLabel}.png`;
